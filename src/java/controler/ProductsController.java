...
public class ProductsController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ProductsD productosDAO = new ProductsD();
        String accion;
        ...
        if (accion == null || accion.isEmpty()) {
            ...
            List<Products> listaProductos = productosDAO.listarProductos();
            ...
            Products producto = new Products(0, codigo, nombre, precio, existencia);
            ...
            Products producto = productosDAO.mostarProducto(id);
